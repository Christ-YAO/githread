...
export function Footer() {
    ...
    return (
        <header className="fixed z-20 bottom-0 w-full dark:bg-[#09090bcf] backdrop-blur-xl md:hidden">
            <div className="container flex items-center justify-between py-1 max-w-5xl m-auto gap-4">
                {/* Links */}
                <div className="py-1 flex-1 flex justify-evenly items-center container gap-4 ">
                    <Link
                        href="/"
                        className={clsx(
                            buttonVariants({
